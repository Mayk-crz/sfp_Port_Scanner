...
# Purpose:     SpiderFoot plug-in for open/filtered ports discovery using NMAP Python.
#
# Author:      Miguel Angel Ramirez Craquis
#
# Created:     05/10/2022
# Copyright:   (c) Miguel Angel Ramirez Craquis 2022
# Licence:     GPL
# -------------------------------------------------------------------------------
